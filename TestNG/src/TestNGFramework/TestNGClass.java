...
public class TestNGClass {
	    ...
	    @Test(priority=1)
	        ...
	        driver.findElement(By.id("Email")).sendKeys("priya.krishna@innobitsystems.com");
	        driver.findElement(By.id("next")).click();
	        Thread.sleep(2000);

	        //Clear pass and enter password, click submit
	        driver.findElement(By.id("Passwd")).clear();
	        driver.findElement(By.id("Passwd")).sendKeys("Aug@2021");
	    ...
	    @Test(priority=2)
	        ...
	        driver.findElement(By.xpath("//textarea[@name='to']")).sendKeys("priya.krishna@innobitsystems.com");
	    ...
	    public void GmailLogout() throws Exception
	    {
	        ...
	        if ( Title != "+priya.krishna@innobitsystems.com+")
	        {
